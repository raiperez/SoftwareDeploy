...
class EpisodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post episodes_url, params: { episode: { length: @episode.length, season_id: @episode.season_id, summary: @episode.summary } }
    end
  ...
  test "should update episode" do
    patch episode_url(@episode), params: { episode: { length: @episode.length, season_id: @episode.season_id, summary: @episode.summary } }
