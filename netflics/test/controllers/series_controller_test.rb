...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post series_index_url, params: { series: { country: @series.country, genre: @series.genre, language: @series.language } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { country: @series.country, genre: @series.genre, language: @series.language } }
