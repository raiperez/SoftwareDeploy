...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { series_id: @season.series_id, summary: @season.summary, year: @season.year } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { series_id: @season.series_id, summary: @season.summary, year: @season.year } }
